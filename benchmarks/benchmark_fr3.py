"""Shim: benchmark_fr3 was relocated to avoidance_obstacle/sim/ when the two papers
...
_real = _P(__file__).resolve().parents[2] / "avoidance_obstacle" / "sim" / "benchmark_fr3.py"
