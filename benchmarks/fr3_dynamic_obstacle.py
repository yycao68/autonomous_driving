"""Shim: fr3_dynamic_obstacle was relocated to avoidance_obstacle/sim/ when the two papers
...
_real = _P(__file__).resolve().parents[2] / "avoidance_obstacle" / "sim" / "fr3_dynamic_obstacle.py"
