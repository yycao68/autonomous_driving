...
as Time-Optimal Trajectory Generation (TOTG) \cite{lertkultanon2016},
...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{benchmarks/topp_phaseplane.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{benchmarks/fr3_accel_compare.png}
...
\(1.047\times\)), the dense path still violates (\(1.12\times\)), and the
...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{benchmarks/dynamic_obstacle.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{benchmarks/fr3_dynamic.png}
